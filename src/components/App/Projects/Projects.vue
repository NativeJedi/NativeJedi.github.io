    ...
    <div class="container">
      ...
      <div class="projects">
        <div class="filters-wrap">
          <div
            v-if="activeFilter"
            :style="{width: `${activeFilter.size}px`, left: `${activeFilter.distance}px`}"
            class="filters-bg"
          />
          <ul class="filters">
      ...
      return [
        {
          ...
          technologies:
            "HTML, CSS, SCSS, Vue.js, Nuxt.js, Vuex, vue-i18n, Axios",
        ...
        },
        {
          ...
          images: [
            require("~/static/images/mvc/react.jpg"),
  ...
  methods: {
    calcFilter() {
      ...
      Array.prototype.map.call(filters, (btn, index) => {
        const leftDist =
          btn.offsetLeft - btn.parentElement.parentElement.offsetLeft;
